...
function TooltipContent({
    ...
    return (
        <TooltipContentPrimitive
            className={cn(
                'z-50 w-fit bg-black dark:bg-white text-primary-foreground dark:text-black rounded',
                className,
            )}
            {...props}
        >
            ...
            <TooltipArrowPrimitive
                className="fill-black dark:fill-white size-3 data-[side='bottom']:translate-y-[1px] data-[side='right']:translate-x-[1px] data-[side='left']:translate-x-[-1px] data-[side='top']:translate-y-[-1px]"
                tipRadius={2}
            />
        </TooltipContentPrimitive>
    );
