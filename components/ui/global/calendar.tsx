...
import { Button, buttonVariants } from "@/components/ui/global/button"
import {
    Select,
    SelectContent,
    SelectItem,
                ...
                Dropdown: ({ value, onChange, options }) => {
                    ...
                    return (
                        <Select value={value?.toString()} onValueChange={handleChange}>
                            <SelectTrigger className="h-7 z-50 w-fit gap-1 border-none bg-transparent px-1 py-0 text-sm font-medium shadow-none focus:ring-0 focus:ring-offset-0 [&>svg]:hidden cursor-pointer focus-visible:ring-0 focus-visible:ring-offset-0 focus-visible:outline-none">
